...
int main()
{
	...
	TEST("FsaSuggestedSize", suggested_size, 32);
	...
	TEST("FsaCountFreeBlocks(3)", FsaCountFreeBlocks(fsa_pool), 3);
	
	block1 = FsaAllocBlock(fsa_pool);	
	
	TEST("FsaAllocBlock1", ((size_t)block1 == (size_t)((char*)fsa_pool + 8)), 1);
	
	block2 = FsaAllocBlock(fsa_pool);
	
	TEST("FsaAllocBlock2", ((size_t)block2 == (size_t)((char*)fsa_pool + 16)), 1);	
	
	TEST("FsaCountFreeBlocks(1)", FsaCountFreeBlocks(fsa_pool), 1);
	
	FsaFreeBlock(fsa_pool, block1);

	block3 = FsaAllocBlock(fsa_pool);
	
	TEST("FsaFreeBlock", ((size_t)block3 == (size_t)((char*)fsa_pool + 8)), 1);
	
	block1 = FsaAllocBlock(fsa_pool);	
	
	TEST("FsaAllocBlock3", ((size_t)block1 == (size_t)((char*)fsa_pool + 24)), 1);
